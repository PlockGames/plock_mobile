"use strict";
const type_ofa = 'object_force_add';
Blockly.defineBlocksWithJsonArray([
    {
        "type": type_ofa,
        "message0": "add force %1 of object  %2 to %3",
        "args0": [
            {
                "type": "field_dropdown",
                "name": "value",
...
javascript.javascriptGenerator.forBlock[type_ofa] = function (block, generator) {
    ...
    return `sendMessage("addForce", JSON.stringify([${object}, '${value}', ${new_value}]));\n`;
};
dart.dartGenerator.forBlock[type_ofa] = function (block, generator) {
    const value = block.getFieldValue('value');
    ...
    return `addForce(${object}, '${value}', ${new_value});\n`;
};
lua.luaGenerator.forBlock[type_ofa] = function (block, generator) {
    const value = block.getFieldValue('value');
...
php.phpGenerator.forBlock[type_ofa] = function (block, generator) {
    const value = block.getFieldValue('value');
...
python.pythonGenerator.forBlock[type_ofa] = function (block, generator) {
    const value = block.getFieldValue('value');
