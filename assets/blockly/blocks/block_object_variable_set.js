"use strict";
const type_ovset = 'object_variable_set';
...
javascript.javascriptGenerator.forBlock[type_ovset] = function (block, generator) {
    ...
    return `sendMessage("setVariableValue", JSON.stringify([${object}, ${name}, ${newValue}]))\n`;
};
dart.dartGenerator.forBlock[type_ovset] = function (block, generator) {
    ...
    return `setComponentValue(${object}, 'ComponentVariable', 'VALUE', toString(${newValue}))\n`;
};
lua.luaGenerator.forBlock[type_ovset] = function (block, generator) {
...
php.phpGenerator.forBlock[type_ovset] = function (block, generator) {
    ...
    return `setComponentValue(${object}, 'ComponentVariable', 'VALUE', ${newValue})\n`;
};
python.pythonGenerator.forBlock[type_ovset] = function (block, generator) {
