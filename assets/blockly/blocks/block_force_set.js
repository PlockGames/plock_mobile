"use strict";
const type_ofs = 'object_force_set';
Blockly.defineBlocksWithJsonArray([
    {
        "type": type_ofs,
        "message0": "set force %1 of object  %2 to %3",
        "args0": [
            {
                "type": "field_dropdown",
                "name": "value",
...
javascript.javascriptGenerator.forBlock[type_ofs] = function (block, generator) {
    ...
    return `sendMessage("setForce", JSON.stringify([${object}, '${value}', ${new_value}]));\n`;
};
dart.dartGenerator.forBlock[type_ofs] = function (block, generator) {
    const value = block.getFieldValue('value');
    ...
    return `setForce(${object}, '${value}', ${new_value});\n`;
};
lua.luaGenerator.forBlock[type_ofs] = function (block, generator) {
    const value = block.getFieldValue('value');
...
php.phpGenerator.forBlock[type_ofs] = function (block, generator) {
    const value = block.getFieldValue('value');
...
python.pythonGenerator.forBlock[type_ofs] = function (block, generator) {
    const value = block.getFieldValue('value');
