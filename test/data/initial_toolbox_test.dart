...
void main() {
  group('Initial Toolbox Tests', () {
    ...
    test('Toolbox should contain all expected categories', () {
      final categoryNames =
          initialToolbox.categories.map((c) => c.name).toList();
    ...
    test('Logic category should contain the correct blocks', () {
      ...
      final blockTypes =
          logicCategory.blocks?.map((b) => b.data['type']).toList();
    ...
    test('Math category should contain the correct blocks', () {
      ...
      final blockTypes =
          mathCategory.blocks?.map((b) => b.data['type']).toList();
    ...
    test('Objects category should contain game-specific blocks', () {
      ...
      final blockTypes =
          objectsCategory.blocks?.map((b) => b.data['type']).toList();
    ...
    test('System category should contain system-related blocks', () {
      ...
      final blockTypes =
          systemCategory.blocks?.map((b) => b.data['type']).toList();
