/// The html colour rgb script
String htmlColourRgbScript() {
  return '''
// =======================================================
...
// eslint-disable-next-line @typescript-eslint/naming-convention
            ...
            moveHighlightBy(dx, dy) {
                ...
                const cell = (this.pickerHTMLElement).childNodes[y].childNodes[
                    x
                    ];
            ...
            static fromJson(options) {
                // `this` might be a subclass of FieldColour if that class doesn't
